import { AnimalsSong } from "./index";

describe("Animals", () => {
  it("verse 1", () => {
    expect(AnimalsSong().verse(1))
      .toEqual(`1 petit lapin blanc sautant sur le chemin 
...
`);
  ...
  it("verse 2", () => {
    expect(AnimalsSong().verse(2))
      .toEqual(`2 petits lapins blancs sautant sur le chemin 
...
`);
  ...
  it("verse 7", () => {
    expect(AnimalsSong().verse(7))
      .toEqual(`7 petits lapins blancs sautant sur le chemin 
Rencontrent 1 autre petit lapin blanc
